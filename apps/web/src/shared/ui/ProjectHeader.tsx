...
export function ProjectHeader({ projectName, subtitle, isArchived = false }: ProjectHeaderProps) {
  return (
    <div className="shell-bar border-b px-4 py-4">
      <div className="mx-auto flex max-w-[90rem] flex-wrap items-end justify-between gap-2">
        <div>
          <p className="text-xs font-medium uppercase tracking-wide text-slate-500 dark:text-slate-400">Project</p>
          <div className="flex flex-wrap items-center gap-2">
            <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">{projectName}</h1>
            {isArchived ? (
